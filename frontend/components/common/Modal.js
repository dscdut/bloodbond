...
const Modal = ({modal, setModal}) => {
  ...
  return (
    <>
      <PureModal
        //header={<div className="bg-red-600 p-2 font-bold text-lg text-center text-white">Category</div>}
        isOpen={modal}
        width="800px"
        onClose={() => {
          setModal(false);
      ...
      >
        <div className="flex-row space-y-3 relative">
            <div className="bg-red-600 p-2 font-bold text-lg text-center text-white -mt-4 -mx-4 mb-5 pb-4">
                <p>Category</p>
            </div>
            <div className="flex justify-between">
                <label className="font-semibold pr-2">Name</label>
                <input className="border-2 border-red-600/50 w-[75%] " type="text" />
            </div>
            <div className="flex justify-between">
                <label className="font-semibold pr-2">Category</label>
                <select className="border-2 border-red-600/50 w-[75%] " type="text">
