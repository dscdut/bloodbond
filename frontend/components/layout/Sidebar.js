	...
	return (
		...
		>
			<Link href='/' className='h-24'>
				<span className='inline-flex items-center justify-center h-24 w-24 bg-red-500 hover:bg-red-400 focus:bg-red-500 cursor-pointer'>
					<svg viewBox='0 0 420 420'>
						<g>
							<g>
								<path
									class='st0'
									d='M262,203.92c-0.62-22-32.92-53.71-34.26-55.05l-1.9-1.9l-1.76,2.03c-0.98,1.13-24.07,27.95-31.66,44.6
			...
			c8.88,10.93,19.64,12.94,28.77,12.75C227.98,242.32,263.01,239.7,262,203.92z'
								...
								<g>
									<path
										class='st0'
										d='M195.98,147c-10,0.16-22.69,2.24-32.04,17.29c-0.73,1.1-10.83,15.54-3.54,31.4
				...
				c-5.24-5.6-14.13-12.15-25.18-12.6'
						...
						<g>
							<g>
								<path
									class='st0'
									d='M104.78,256.45c1.41-0.23,3.65-0.41,5.92-0.41c3.24,0,5.35,0.04,6.91,1.04c1.3,0.76,2.17,2.27,2.27,3.53
			...
			c0-1.8-1.8-2.55-3.97-2.55h-1.64V272.82z'
								...
								<path
									class='st0'
									d='M125.67,256.23h5.89v15.96l5.91,0l-0.06,3.91h-11.74V256.23z'
									fill='#FFFFFF'
								/>
								<path
									class='st0'
									d='M187.47,266.19c0,6.91-4.94,10.57-10.97,10.57c-6.24,0-10.62-4.11-10.62-10.18c0-6.37,4.66-10.54,10.97-10.54
			...
			c0-2.86-1.73-5.86-5.31-5.86C173.42,260.6,171.64,263.44,171.64,266.61z'
								...
								<path
									class='st0'
									d='M192.32,256.45c1.71-0.24,3.74-0.42,5.96-0.42c4.03,0,6.89,0.86,8.8,2.49c1.93,1.63,3.06,3.94,3.06,7.17
			...
			c0.48,0.09,1.18,0.11,1.92,0.11c4.07,0,6.27-2.31,6.27-6.35c0.02-3.53-1.95-5.77-5.97-5.77c-0.98,0-1.73,0.09-2.23,0.2V272.04z'
								...
								<path
									class='st0'
									d='M233.64,269.13c-0.35,1.66-3.29,7.21-8.73,7.02c-7.06-0.24-10.13-4.77-10.31-9.85
			...
			c-1.64-0.09-4.66,0.67-4.66,6.34c0,5.28,3.23,5.96,5.45,5.96c1.97,0,3.45-1.49,3.79-3.02H233.64z'
								...
								<path
									class='st0'
									d='M244.6,256.2l0.04,7.82l7.02-0.04l0.12-7.78h4.85l0.08,20.72l-5.07-0.04l-0.12-8.72l-7.02-0.04l0,8.98
			l-5.02-0.04V256.2H244.6z'
									fill='#FFFFFF'
								/>
								<path
									class='st0'
									d='M267.64,272.11l-0.96,4.02h-5.11l7.17-19.93h5.79l7.34,19.93h-5.23l-1.1-4.03L267.64,272.11z M274.3,269.18
			l-1.81-4.58c-0.41-1.04-0.69-1.98-0.96-2.9h-0.06c-0.27,0.94-0.58,1.91-0.93,2.88l-1.81,4.6H274.3z'
									fill='#FFFFFF'
								/>
								<path
									class='st0'
									d='M291.18,256.69v19.94h-5.13v-19.95L291.18,256.69z'
									fill='#FFFFFF'
								/>
								<path
									class='st0'
									d='M297.2,276.64v-19.95h3.34l7.29,9.63c0.91,1.25,2.76,3.68,2.76,3.68l0.03-1.82c-0.03-2.7-0.03-0.58-0.03-3.69
			l-0.02-7.77l4.42-0.03v19.95l-3.99-0.03l-6.74-9.1l0,0l-2.67-3.38c0.05,1.49,0.03,0.55,0.03,3.86l-0.16,8.65H297.2z'
									fill='#FFFFFF'
								/>
								<path
									class='st0'
									d='M162.47,266.19c0,6.91-4.94,10.57-10.97,10.57c-6.24,0-10.62-4.11-10.62-10.18c0-6.37,4.66-10.54,10.97-10.54
