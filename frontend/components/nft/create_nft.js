...
const Create = () => {
	...
	const [displayPic, setDisplayPic] = useState(
		'https://i.ibb.co/P6LTLv6/upload-file.jpg'
	);
				...
				{connStatus && (
					...
					>
						<form>
							<div className='img-container text-center mt-5'>
								...
								<p className='mb-10'>
									...
									create new NFTs using SHYFT APIs.
								</p>
								<div
								...
								<input
									...
									onChange={e => {
										...
										setDisplayPic(
											URL.createObjectURL(file_selected)
										);
									}}
								/>
						...
						<div className='text-center'>
							...
							<code>max_supply</code> parameter to 0. But you can
							update it needed, it should be between <i>0-100</i>.
						</div>
					</div>
				)}
